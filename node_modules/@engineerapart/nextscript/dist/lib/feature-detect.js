export const generateFeatureChecks = (features = []) => {
...
export const featureDetect = ({ scripts, minify = true, allowUserMonitoring = true, useFeatureDetection = true, features = [] }) => {
    const flags = `gated${useFeatureDetection ? ',always' : ''}`;
    const ua = useFeatureDetection ? '&ua=chrome/76.0.0' : '';
    return `
